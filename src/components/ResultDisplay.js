    ...
    <div>
      ...
      <div v-else>
        ...
        <div v-if="breakdown" class="mt-2 text-[14px] text-gray-600 border border-gray-200 rounded-lg p-3 bg-gray-50">
          ...
          <div class="flex items-center py-0.5"><span class="shrink-0">(نسبت به قیمت فروش)کارمزد باسلام</span><span class="mx-2 grow border-b border-dashed border-gray-300"></span><span class="shrink-0 tabular-nums">{{ formatPrice(breakdown.commission) }}</span><span class="shrink-0 text-gray-500 ms-1">تومان</span></div>
